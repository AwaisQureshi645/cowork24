...
$sql = "SELECT * FROM team LIMIT $start_from, $results_per_page";
$result = $conn->query($sql);
if (!$result) {
    die("Query failed: " . $conn->error);
}

$total_results_sql = "SELECT COUNT(*) FROM team";
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td>
                                    <div class='icbtn'>
                                        <a class='btn btn-primary btn-sm' href='/cowork/editTeam.php?TeamID={$row['TeamID']}' role='button'>
                                            <i class='fa-solid fa-pen-to-square'></i>
                                        </a>
                                        <a class='btn btn-danger btn-sm' href='/cowork/deleteTeam.php?TeamID={$row['TeamID']}' role='button'>
