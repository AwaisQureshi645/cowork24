...
$sql = "SELECT * FROM branches LIMIT $start_from, $results_per_page";
$result = $conn->query($sql);
if (!$result) {
    die("Query failed: " . $conn->error);
}

$total_results_sql = "SELECT COUNT(*) FROM branches";
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<tr>
                                ...
                                <td>
                                    <div class='icbtn'>
                                        <a class='btn btn-primary btn-sm' href='/cowork/editBranch.php?branch_id={$row['branch_id']}' role='button'>
                                            <i class='fa-solid fa-pen-to-square'></i>
                                        </a>
                                        <a class='btn btn-danger btn-sm' href='/cowork/deleteBranch.php?branch_id={$row['branch_id']}' role='button'>
