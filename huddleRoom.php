...
$sql = "SELECT * FROM huddleroom LIMIT $start_from, $results_per_page";
$result = $conn->query($sql);
if (!$result) {
    die("Query failed: " . $conn->error);
}

$total_results_sql = "SELECT COUNT(*) FROM huddleroom";
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<tr>
                                  ...
                                  <td>{$row['huddleroomID']}</td>
                                  <td>{$row['name']}</td>
                                  <td>{$row['capacity']}</td>
                                  
                                <td>
                                    <div class='icbtn'>
                                        <a class='btn btn-primary btn-sm' href='/cowork/editHuddle.php?huddleroomID={$row['huddleroomID']}' role='button'>
                                            <i class='fa-solid fa-pen-to-square'></i>
                                        </a>
                                        <a class='btn btn-danger btn-sm' href='/cowork/deleteHuddle.php?huddleroomID={$row['huddleroomID']}' role='button'>
